...
- if `percent_m` increases, it will increase the crime rate because the value is positive
- if `mean_education` increases, it will increase the crime rate because the value is positive value
- If `inequality` increases, it will increase the crime rate because the value is positive
- if `unemployment_m39` increases, it will increase the crime rate because the value is positive
- if `police_exp60` increases, it will increase the crime rate because the value is positive
- if `prob_prison` increases, it will decrease the crime rate because the value is negative
